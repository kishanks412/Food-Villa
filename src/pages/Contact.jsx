...
const details = {
  ...
  contact: {
    email: 'kishankumarseth.ggu@gmail.com',
    github: 'https://github.com/kishanks412',
    linkedin: 'https://www.linkedin.com/in/kishankumarseth/',
    leetcode: 'https://leetcode.com/kishan_412/',
  },
};
      ...
      <div>
        ...
        <div className='my-4 space-y-2'>
          ...
          <p className='flex flex-wrap items-center gap-2'>
            ...
            <a
              href={details.contact.leetcode}
              className='flex items-center gap-1'
            >
              {details.contact.leetcode}
              <ArrowTopRightOnSquareIcon className='w-4 h-4' />
            </a>
          </p>
        </div>
